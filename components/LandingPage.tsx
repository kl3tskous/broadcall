...
export default function LandingPage() {
  ...
  return (
    ...
    >
        ...
        <div className="bg-white/[0.06] backdrop-blur-[10px] rounded-[30px] md:rounded-[50px] h-[70px] md:h-[100px] flex items-center justify-between px-4 md:px-12">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <Link
              ...
              className="bg-gradient-to-r from-[#FF5605] via-[#FF7704] to-[#FFA103] rounded-[20px] md:rounded-[30px] px-4 md:px-8 py-2 md:py-4 hover:opacity-90 transition-opacity inline-block"
            >
      ...
      <div id="waitlist-section" className="relative max-w-[800px] mx-auto px-4 mb-12 md:mb-16">
          ...
          {user && user.joined_waitlist ? (
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-4">
                {user.access_granted 
                  ? "You have access! Click 'Launch App' to get started."
                  : "We'll notify you as soon as we grant you access to BroadCall."}
              </p>
            </div>
          ) : (
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-6">
                Sign up with X (Twitter) to get early access when we launch
              </p>
              <TwitterLoginButton />
              <p className="text-gray-400 text-sm mt-3">
                Connect your X account, then link Telegram to complete signup
              </p>
            </div>
          )}
        </div>
