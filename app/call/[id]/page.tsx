...
export default function CallPage() {
  ...
  return (
    <main className="min-h-screen relative bg-gray-900">
        ...
        {creatorBanner && (
          <>
            {/* Banner Background Image - Stops at tabs on mobile, full height on desktop */}
            <div className="fixed top-0 left-0 w-full h-[220px] md:h-screen z-0">
              <img 
                src={creatorBanner} 
                alt="Profile banner" 
            ...
            <div className="fixed top-0 left-0 w-full h-[220px] md:h-screen z-0 bg-gradient-to-b from-transparent via-gray-900/50 to-gray-900" />
          </>
        )}
